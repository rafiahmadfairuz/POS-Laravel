<aside id="sidebar-multi-level-sidebar "
    ...
    aria-label="Sidebar">
    <div class="h-full flex flex-col justify-between px-3 py-4 overflow-y-auto bg-gray-50 border-r border-emerald-200 border">
        <ul class="space-y-2 font-medium">
         ...
         <form action="{{ route('logout') }}" method="POST">
            @csrf
            <button type="submit"
            class="flex align-bottom text-red-500 p-2  rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
