...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/purchases', [PembelianController::class, 'index'])->name('pembelian.index');
    Route::get('/purchases-form', [PembelianController::class, 'transaksiBaru'])->name('transaksi.baru');
    Route::post('/cari', [PembelianController::class, 'cariProduk'])->name('cari.produk');
